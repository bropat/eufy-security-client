...
import { encodePasscode, getAdvancedLockTimezone, getBlocklist, getFloodLightT8425Notification, getHB3DetectionMode, getIndoorNotification, getIndoorS350DetectionMode, getT8110DetectionMode, getT8170DetectionMode, hexDate, hexTime, hexWeek, isGreaterEqualMinVersion, isNotificationSwitchMode, isPrioritySourceType, switchNotificationMode, switchSmartLockNotification } from "./utils";
...
export class Station extends TypedEmitter<StationEvents> {
    ...
    public setStatusLed(device: Device, value: boolean): void {
        ...
        if (device.isCamera2Product() || device.isCamera3Product() || device.getDeviceType() === DeviceType.CAMERA || device.getDeviceType() === DeviceType.CAMERA_E || device.isCameraProfessional247() || (device.isCameraC35() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithIntString({
        ...
        } else if (device.getDeviceType() === DeviceType.FLOODLIGHT_CAMERA_8424 || (device.isCameraC35() && !this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithStringPayload({
        ...
        } else if (device.getDeviceType() === DeviceType.FLOODLIGHT_CAMERA_8423 || device.isFloodLightT8425() || (device.getDeviceType() === DeviceType.FLOODLIGHT && !device.isFloodLightT8420X()) || device.isGarageCamera() || (device.isIndoorPanAndTiltCameraS350() && this.isDeviceControlledByHomeBase()) || (device.isSoloCameras() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithIntString({
                commandType: CommandType.CMD_DEV_LED_SWITCH,
                value: value === true ? 1 : 0,
                valueSub: device.getChannel(),
    ...
    public setNightVision(device: Device, value: number): void {
        ...
        if (device.isCameraProfessional247() || device.isIndoorPanAndTiltCameraS350() || device.isFloodLightT8425() || device.isCameraC35()) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_SET_PAYLOAD,
                value: JSON.stringify({
                    "account_id": this.rawStation.member.admin_user_id,
    ...
    public setMotionDetection(device: Device, value: boolean): void {
        ...
        if (device.isSoloCameraSolar() || device.isOutdoorPanAndTiltCamera() || device.isSoloCameraC210() || ((device.isIndoorPanAndTiltCameraS350() || device.isCameraC35()) && !this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD,
                value: JSON.stringify({
    ...
    public switchLight(device: Device, value: boolean): void {
        ...
        if ((device.isFloodLight() && !device.isFloodLightT8425()) || device.isSoloCameraSpotlight1080() || device.isSoloCameraSpotlight2k() ||
            ...
            device.isIndoorOutdoorCamera1080p() || device.isIndoorOutdoorCamera2k() || device.isCamera3() || device.isCamera3C() || device.isCameraProfessional247() || device.isCamera3Pro() || (device.isCameraC35() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithIntString({
    ...
    public setMotionDetectionSensitivity(device: Device, value: number): void {
        ...
        if ((device.isFloodLight() && device.getDeviceType() !== DeviceType.FLOODLIGHT && !device.isFloodLightT8425()) || (device.isIndoorCamera() && !device.isIndoorPanAndTiltCameraS350()) || device.isFloodLightT8420X() || device.isGarageCamera() || (device.isIndoorPanAndTiltCameraS350() && !this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD,
                value: JSON.stringify({
        ...
        } else if ((device.isSoloCameras() && !this.isDeviceControlledByHomeBase()) || device.isWiredDoorbellT8200X() || device.isStarlight4GLTE()) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD,
                value: JSON.stringify({
                    "commandType": CommandType.CMD_SET_PIR_SENSITIVITY,
        ...
        } else if (device.isCamera3Product() || device.isSmartDrop() || (device.isSoloCameras() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithIntString({
                commandType: CommandType.CMD_SET_PIRSENSITIVITY,
                value: value,
                valueSub: device.getChannel(),
    ...
    public setMotionDetectionTypeHB3(device: Device, type: HB3DetectionTypes | T8170DetectionTypes | SoloCameraDetectionTypes | IndoorS350DetectionTypes | EufyCamC35DetectionTypes, value: boolean): void {
        const propertyData: PropertyData = {
        ...
        if (this.getDeviceType() === DeviceType.HB3) {
            ...
            try {
                if (!Object.values(EufyCamC35DetectionTypes).includes(type as EufyCamC35DetectionTypes)) {
                    rootHTTPLogger.error(`The device ${device.getSerial()} accepts only this type of values:`, Object.values(EufyCamC35DetectionTypes).filter((value) => typeof value === "number"));
                    return;
                }
                const aiDetectionType = device.getRawProperty(device.getPropertyMetadata(propertyData.name).key as number) !== undefined ? device.getRawProperty(device.getPropertyMetadata(propertyData.name).key as number)! : "0";
                const newAiDetectionType = getT8110DetectionMode(Number.parseInt(aiDetectionType), type as EufyCamC35DetectionTypes, value);
                this.p2pSession.sendCommandWithStringPayload({
                    commandType: CommandType.CMD_SET_PAYLOAD,
                    value: JSON.stringify({
                        "account_id": this.rawStation.member.admin_user_id,
                ...
                const error = ensureError(err);
                rootHTTPLogger.error(`setMotionDetectionTypeHB3 EufyCamC35DetectionTypes Error`, { error: getError(error), stationSN: this.getSerial(), deviceSN: device.getSerial() });
            }
    ...
    public setAudioRecording(device: Device, value: boolean): void {
        ...
        } else if (device.isOutdoorPanAndTiltCamera() || (device.isIndoorPanAndTiltCameraS350() && !this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD,
                value: JSON.stringify({
        ...
        } else if ((device.isFloodLight() && !device.isFloodLightT8425()) || (device.isIndoorCamera() && !device.isIndoorPanAndTiltCameraS350()) || (device.isSoloCameras() && !this.isDeviceControlledByHomeBase()) || device.isStarlight4GLTE()) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD,
                value: JSON.stringify({
                    "commandType": CommandType.CMD_INDOOR_SET_RECORD_AUDIO_ENABLE,
        ...
        } else if (device.isBatteryDoorbellDualE340() || device.isSmartDrop() || device.isLockWifiVideo() || device.isCameraProfessional247() || device.isIndoorPanAndTiltCameraS350() || device.isFloodLightT8425() || (device.isSoloCameras() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_SET_PAYLOAD,
                value: JSON.stringify({
                    "account_id": this.rawStation.member.admin_user_id,
    ...
    public setNotificationType(device: Device, value: NotificationType | WalllightNotificationType): void {
        ...
        if ((device.isFloodLight() && !device.isFloodLightT8425()) || (device.isIndoorCamera() && !device.isIndoorPanAndTiltCameraS350()) || (device.isSoloCameras() && !this.isDeviceControlledByHomeBase()) || device.isStarlight4GLTE() || device.isGarageCamera()) {
        ...
        } else if (device.isCameraProfessional247() || (device.isIndoorPanAndTiltCameraS350() && this.isDeviceControlledByHomeBase()) || device.isFloodLightT8425() || (device.isSoloCameras() && this.isDeviceControlledByHomeBase())) {
            if (!Object.values(NotificationType).includes(value as NotificationType)) {
                rootHTTPLogger.error(`The device ${device.getSerial()} accepts only this type of values:`, Object.values(NotificationType).filter((value) => typeof value === "number"));
                return;
            }
    ...
    public setVideoStreamingQuality(device: Device, value: number): void {
        ...
        } else if (device.isOutdoorPanAndTiltCamera() || device.isIndoorPanAndTiltCameraS350() || device.isFloodLightT8425() || (device.isCameraC35() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_SET_PAYLOAD,
                value: JSON.stringify({
                    "account_id": this.rawStation.member.admin_user_id,
        ...
        } else if (device.isIndoorCamera() || (device.isSoloCameras() && !this.isDeviceControlledByHomeBase()) || device.isFloodLight() || device.isWiredDoorbell() || device.isStarlight4GLTE() || device.isGarageCamera()) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD,
                value: JSON.stringify({
        ...
        } else if (device.isBatteryDoorbell() || device.isCamera2CPro() || device.isWiredDoorbellDual() || device.isCamera3() || device.isCamera3C() || device.isCamera3Pro() || device.isSmartDrop() || device.isLockWifiVideo() || device.isCameraProfessional247() || (device.isSoloCameras() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithIntString({
    ...
    public setVideoRecordingQuality(device: Device, value: number): void {
        ...
        } else if (device.isIndoorCamera() || device.isWiredDoorbell() || device.isFloodLight() || (device.isSoloCameras() && !this.isDeviceControlledByHomeBase()) || device.isStarlight4GLTE() || device.isGarageCamera()) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD,
                value: JSON.stringify({
        ...
        } else if (device.isCamera2CPro() || device.isCamera3() || device.isCamera3C() || device.isCameraProfessional247() || device.isCamera3Pro() || (device.isCameraC35() && this.isDeviceControlledByHomeBase())) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: CommandType.CMD_SET_PAYLOAD,
                value: JSON.stringify({
                    "account_id": this.rawStation.member.admin_user_id,
    ...
    public setStationNotificationSwitchMode(mode: NotificationSwitchMode, value: boolean): void {
        ...
        } else if (this.getDeviceType() === DeviceType.OUTDOOR_PT_CAMERA || Device.isSoloCameraC210(this.getDeviceType()) || Device.isCameraC35(this.getDeviceType()) && !this.isDeviceControlledByHomeBase()) {
            let oldvalue = 0;
            const rawproperty = this.getRawProperty(CommandType.CMD_HUB_NOTIFY_MODE);
            if (rawproperty !== undefined) {
                try {
    ...
    public setWatermark(device: Device, value: WatermarkSetting1 | WatermarkSetting2 | WatermarkSetting3 | WatermarkSetting4 | WatermarkSetting5): void {
        ...
        if (device.isCamera2Product() || device.isCamera3Product() || device.isSoloCameraSolar() || device.isOutdoorPanAndTiltCamera() || device.isCameraProfessional247() || device.isIndoorPanAndTiltCameraS350() || device.isSoloCameraC210() || device.isFloodLightT8425() || device.isCameraC35()) {
    ...
    public enableDevice(device: Device, value: boolean): void {
        ...
        } else if (device.isIndoorCamera() && isGreaterEqualMinVersion("2.3.1.0", device.getSoftwareVersion()) && Station.isDeviceControlledByHomeBaseBySn(device.getStationSerial())) {
    ...
    public startLivestream(device: Device, videoCodec: VideoCodec = VideoCodec.H264): void {
        ...
        } else if (((device.isIndoorPanAndTiltCameraS350() || device.isIndoorCamC24()) && this.isDeviceControlledByHomeBase()) || device.isFloodLightT8425()) {
    ...
    public startTalkback(device: Device): void {
        ...
        } else if ((device.isBatteryDoorbell() && isGreaterEqualMinVersion("2.0.6.8", this.getSoftwareVersion())) || device.isIndoorPanAndTiltCameraS350() || device.isFloodLightT8425() || (device.isSoloCamera() && this.isDeviceControlledByHomeBase()) || device.isLockWifiVideo() || device.isSmartDrop()) {
            this.p2pSession.sendCommandWithInt({
