...
export class Station extends TypedEmitter<StationEvents> {
    ...
    protected convertRawPropertyValue(property: PropertyMetadataAny, value: string): PropertyValue {
        try {
            ...
            if (property.name === PropertyName.Model && Device.isLockWifiT8510P(this.getDeviceType(), this.getSerial())) {
                return "T8510P";
            } else if (property.name === PropertyName.Model && Device.isLockWifiT85V0(this.getDeviceType(), this.getSerial())) {
                return "T85V0";
    ...
    public getLockParameters(): void {
        ...
        if (Device.isLockWifiT8506(this.getDeviceType()) || Device.isLockWifiT8502(this.getDeviceType()) || Device.isLockWifiT8510P(this.getDeviceType(), this.getSerial()) || Device.isLockWifiT8520P(this.getDeviceType(), this.getSerial()) || Device.isLockWifiT85V0(this.getDeviceType(), this.getSerial())) {
