...
export class Station extends TypedEmitter<StationEvents> {
  ...
  static async getInstance(
    ...
    if (
      ...
      !Device.isLockWifiT8531(stationData.device_type) &&
      !Device.isLockWifiVideo(stationData.device_type) &&
  ...
  public isIntegratedDevice(): boolean {
    ...
    if (
      ...
      if (this.rawStation.devices?.length === 1)
        return (
          this.rawStation.devices[0]?.device_sn === this.rawStation.station_sn
        );
      else return true;
    }
    return (
  ...
  public setStatusLed(device: Device, value: boolean): void {
    ...
    if (
      ...
      (device.isIndoorPanAndTiltCameraS350() && this.isStationHomeBase3()) ||
  ...
  public setMotionDetectionTypeHB3(
    ...
    if (this.getDeviceType() === DeviceType.HB3) {
      try {
        if (
          !Object.values(HB3DetectionTypes).includes(type as HB3DetectionTypes)
        ) {
          rootHTTPLogger.error(
        ...
        const aiDetectionType =
          device.getRawProperty(
            device.getPropertyMetadata(propertyData.name).key as number,
          ) !== undefined
            ? device.getRawProperty(
                device.getPropertyMetadata(propertyData.name).key as number,
              )!
          ...
          value: JSON.stringify({
            ...
            payload: {
              ...
              notification_ring_onoff:
                device.getPropertyValue(PropertyName.DeviceNotificationRing) ===
                true
                  ? 1
                  : 0,
  ...
  public setStationNotificationSwitchMode(
    ...
    if (
      ...
      (!this.hasProperty(PropertyName.StationNotificationSwitchModeGeofence) &&
        mode === NotificationSwitchMode.GEOFENCE) ||
      (!this.hasProperty(PropertyName.StationNotificationSwitchModeKeypad) &&
        mode === NotificationSwitchMode.KEYPAD) ||
  ...
  public setWatermark(
    ...
    if (
      ...
      if (
        !Object.values(WatermarkSetting3).includes(value as WatermarkSetting3)
      ) {
        rootHTTPLogger.error(
          `The device ${device.getSerial()} accepts only this type of values:`,
      ...
      if (
        !Object.values(WatermarkSetting1).includes(value as WatermarkSetting1)
      ) {
        rootHTTPLogger.error(
          `The device ${device.getSerial()} accepts only this type of values:`,
      ...
      if (
        !Object.values(WatermarkSetting4).includes(value as WatermarkSetting4)
      ) {
        rootHTTPLogger.error(
          `The device ${device.getSerial()} accepts only this type of values:`,
      ...
      if (
        !Object.values(WatermarkSetting2).includes(value as WatermarkSetting2)
      ) {
        rootHTTPLogger.error(
          `The device ${device.getSerial()} accepts only this type of values: `,
      ...
      if (
        !Object.values(WatermarkSetting5).includes(value as WatermarkSetting5)
      ) {
        rootHTTPLogger.error(
          `The device ${device.getSerial()} accepts only this type of values:`,
  ...
  public lockDevice(device: Device, value: boolean): void {
    ...
    if (device.isLockBleNoFinger() || device.isLockBle()) {
      ...
      const deviceSN = device.isLockWifiT8531()
        ? device.getSerial()
        : this.rawStation.station_sn;
  ...
  public setAdvancedLockParams(
    ...
    if (device.isLockWifi() || device.isLockWifiNoFinger()) {
      ...
      if (p2pParamName !== "") {
        payload[p2pParamName] = this.convertAdvancedLockSettingValueT8530(
          property,
          value,
        );
        rootHTTPLogger.debug(
              ...
              setting: [
                {
                  ...
                  auto_voice_name: (device as DoorbellCamera).getVoiceName(
                    voiceID,
                  ),
  ...
  public startTalkback(device: Device): void {
    ...
    if (
      ...
      (device.isBatteryDoorbell() &&
        isGreaterEqualMinVersion("2.0.6.8", this.getSoftwareVersion())) ||
      device.isIndoorPanAndTiltCameraS350() ||
      device.isFloodLightT8425() ||
      (device.isSoloCamera() && this.isStationHomeBase3()) ||
      device.isLockWifiVideo() ||
  ...
  public unlock(device: Device): void {
    ...
    this._sendSmartSafeCommand(device, SmartSafeCommandCode.UNLOCK, payload, {
      command: commandData,
    });
  }
      ...
      this.p2pSession.sendCommandWithStringPayload(
        {
          ...
          value: JSON.stringify({
            ...
            chime_onoff:
              value.snooze_chime !== undefined && value.snooze_chime ? 1 : 0,
            motion_notify_onoff:
              value.snooze_motion !== undefined && value.snooze_motion ? 1 : 0,
            homebase_onoff:
              value.snooze_homebase !== undefined && value.snooze_homebase
                ? 1
                : 0,
          }),
          channel: device.getChannel(),
  ...
  public getLockParameters(): void {
    ...
    if (
      ...
      Device.isLockWifiT8531(this.getDeviceType()) ||
  ...
  public getLockStatus(): void {
    ...
    if (
      ...
      rootHTTPLogger.debug(`Station smart lock send get lock status command`, {
        stationSN: this.getSerial(),
      });
      const command = getSmartLockP2PCommand(
        this.rawStation.station_sn,
      ...
      rootHTTPLogger.debug(`Station lock v12 send get lock status command`, {
        stationSN: this.getSerial(),
      });
      const command = getLockV12P2PCommand(
        this.rawStation.station_sn,
