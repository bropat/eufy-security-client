...
export class Device extends TypedEmitter<DeviceEvents> {
        ...
        if (
            ...
            try {
                ...
                if (error instanceof InvalidPropertyError) {
                    ...
                    rootHTTPLogger.error(
                        `Device update property - Property error`,
                        {
                            error: getError(error),
                            deviceSN: this.getSerial(),
                            propertyName: name,
    ...
    protected convertRawPropertyValue(
        ...
        try {
            ...
            if (
                ...
                switch (property.name) {
                    case PropertyName.DeviceNotificationRing: {
                        const booleanProperty =
                            property as PropertyMetadataBoolean;
                        try {
                            return val &&
                                val.notification_ring_onoff !== undefined
                                ? Number.parseInt(
                                      val.notification_ring_onoff
                                  ) === 1
                    ...
                    case PropertyName.DeviceNotificationMotion: {
                        ...
                        try {
                            return val &&
                                val.notification_motion_onoff !== undefined
                                ? Number.parseInt(
                                      val.notification_motion_onoff
                                  ) === 1
                                : (booleanProperty.default ?? false);
                        } catch (err) {
                            const error = ensureError(err);
                    ...
                    case PropertyName.DeviceNotificationType: {
                        const numericProperty =
                            property as PropertyMetadataNumeric;
                        try {
                ...
                switch (property.name) {
                    case PropertyName.DeviceLoiteringCustomResponseTimeFrom: {
                        const stringProperty =
                            property as PropertyMetadataString;
                        try {
                ...
                try {
                    return value !== undefined &&
                        val.ai_bottom_switch !== undefined
                ...
                try {
                    return val?.start_h !== undefined &&
                        val?.start_m !== undefined
                ...
                switch (property.name) {
                    ...
                    case PropertyName.DeviceRingAutoResponseTimeFrom: {
                        const stringProperty =
                            property as PropertyMetadataString;
                        try {
                            return (value as any)?.setting?.length !==
                                undefined &&
                                (value as any)?.setting?.length > 0 &&
                                (value as any)?.setting[0]?.start_hour !==
                                    undefined &&
                                (value as any)?.setting[0]?.start_min !==
                                    undefined
                    ...
                    case PropertyName.DeviceRingAutoResponseTimeTo: {
                        ...
                        try {
                            return (value as any)?.setting?.length !==
                                undefined &&
                                (value as any)?.setting?.length > 0 &&
                                (value as any)?.setting[0]?.end_hour !==
                                    undefined &&
                                (value as any)?.setting[0]?.end_min !==
                                    undefined
                ...
                property.key === CommandType.CMD_DOORBELL_DUAL_RADAR_WD_TIME
            ) {
                const numericProperty = property as PropertyMetadataNumeric;
                try {
                    return value !== undefined &&
                ...
                property.key === CommandType.CMD_BAT_DOORBELL_VIDEO_QUALITY2
            ) {
                const numericProperty = property as PropertyMetadataNumeric;
                ...
                property.key === CommandType.SUB1G_REP_UNPLUG_POWER_LINE
            ) {
                const numericProperty = property as PropertyMetadataNumeric;
                try {
    ...
    public getPropertiesMetadata(hidden = false): IndexedProperty {
        ...
        if (
            ...
            newMetadata[PropertyName.DeviceMotionDetected] =
                DeviceMotionDetectedProperty;
            newMetadata[PropertyName.DevicePetDetected] =
                DevicePetDetectedProperty;
            ...
            newMetadata[PropertyName.DeviceVehicleDetected] =
                DeviceVehicleDetectedProperty;
            newMetadata[PropertyName.DeviceDogDetected] =
                DeviceDogDetectedProperty;
            ...
            if (!this.isSmartDrop()) {
                ...
                newMetadata[PropertyName.DeviceEnabled] =
                    DeviceEnabledSoloProperty;
            }
    ...
    static isLockKeypad(type: number): boolean {
        return (
            Device.isLockWifiR10Keypad(type) || Device.isLockWifiR20Keypad(type)
        );
    }
    ...
    public isIndoorOutdoorCamera1080pNoLight(): boolean {
        return Device.isIndoorOutdoorCamera1080pNoLight(
            this.rawDevice.device_type
        );
    }
        ...
        if (
            ...
            if (message.device_sn === this.getSerial()) {
                try {
                    ...
                    const error = ensureError(err);
                    rootHTTPLogger.debug(
                        `SoloCamera process push notification - Error`,
                        {
                            error: getError(error),
                            deviceSN: this.getSerial(),
                            message: JSON.stringify(message),
...
export class FloodlightCamera extends Camera {
    ...
    protected convertRawPropertyValue(
        ...
        try {
            ...
            const error = ensureError(err);
            rootHTTPLogger.error(
                "FloodlightCamera convert raw property - Error",
                {
                    error: getError(error),
                    deviceSN: this.getSerial(),
                    property: property,
            ...
            switch (property.key) {
                ...
                case CommandType.CMD_CAMERA_GARAGE_DOOR_STATUS:
                    if (value != undefined) {
                        ...
                        if (status >= 0) {
                            if (
                                property.name === PropertyName.DeviceDoor1Open
                            ) {
                                return (
                                ...
                                property.name === PropertyName.DeviceDoor2Open
                            ) {
                                return (
                ...
                case CommandType.CMD_CAMERA_GARAGE_DOOR_SENSORS:
                    if (value != undefined) {
                        const sensorsData =
                            value as unknown as GarageDoorSensorsProperty;
                        if (
                            property.name ===
                            ...
                            return sensorsData?.data?.door_1?.power !==
                                undefined
                                ? sensorsData?.data?.door_1?.power
                                : 0;
                        } else if (
                            ...
                            return sensorsData?.data?.door_2?.power !==
                                undefined
                                ? sensorsData?.data?.door_2?.power
                                : 0;
                        } else if (
                            ...
                            return sensorsData?.data?.door_1?.mac_address !==
                                undefined
                            ...
                            return sensorsData?.data?.door_2?.mac_address !==
                                undefined
                                ? sensorsData?.data?.door_2?.mac_address
                                : "";
                        } else if (
                            property.name === PropertyName.DeviceDoorSensor1Name
                        ) {
                            return sensorsData?.data?.door_1?.name !== undefined
                                ? sensorsData?.data?.door_1?.name
                                : "";
                        } else if (
                            property.name === PropertyName.DeviceDoorSensor2Name
                        ) {
                            ...
                            return sensorsData?.data?.door_1?.version !==
                                undefined
                            ...
                            return sensorsData?.data?.door_2?.version !==
                                undefined
                            ...
                            return sensorsData?.data?.door_1?.playalarm !==
                                undefined
...
export class Lock extends Device {
    ...
    public static encodeCmdSetLockParamAutoLock(
        ...
        const payload = new WritePayload();
        payload.write(
            this.getUint16BEBuffer(CommandType.CMD_SMARTLOCK_AUTO_LOCK)
        );
    ...
    public static encodeCmdSetLockParamSound(value: number): Buffer {
        const payload = new WritePayload();
        payload.write(
            this.getUint16BEBuffer(CommandType.CMD_SMARTLOCK_LOCK_SOUND)
        );
        payload.write(this.getUInt8Buffer(value));
        payload.write(this.getCurrentTimeInSeconds());
        return payload.getData();
            ...
            switch (property.key) {
                case CommandType.CMD_DOORLOCK_SET_PUSH_MODE:
                    if (property.name === PropertyName.DeviceNotification) {
                        ...
                        property.name === PropertyName.DeviceNotificationLocked
                    ) {
                        return value !== undefined
                            ? isSmartLockNotification(
                                  Number.parseInt(value),
...
export class SmartSafe extends Device {
    ...
    public static encodeCmdDualUnlock(
        user_id: string,
        enabled: boolean
    ): Buffer {
        return SmartSafe.encodeCmdSingleUInt8(
            user_id,
            enabled === true ? 1 : 0
        );
    }
    ...
    public static encodeCmdPowerSave(
        user_id: string,
        enabled: boolean
    ): Buffer {
        return SmartSafe.encodeCmdSingleUInt8(
    ...
    public static encodeCmdTamperAlarm(
        user_id: string,
        option: number
    ): Buffer {
    ...
    public static encodeCmdRemoteUnlock(
        user_id: string,
        option: number
    ): Buffer {
        return SmartSafe.encodeCmdSingleUInt8(user_id, option);
    ...
    public static encodeCmdAlertVolume(
        user_id: string,
        volume: number
    ): Buffer {
    ...
    public static encodeCmdPromptVolume(
        user_id: string,
        volume: number
    ): Buffer {
        return SmartSafe.encodeCmdSingleUInt8(user_id, volume);
                ...
                try {
                    switch (message.event_type) {
                        ...
                        case SmartSafeEvent.INPUT_ERR_MAX: {
                            this.wrongTryProtectAlarmEvent(
                                eventDurationSeconds
                            );
                            break;
                        }
                    ...
                    const error = ensureError(err);
                    rootHTTPLogger.debug(
                        `SmartSafe process push notification - Error`,
                        {
                            error: getError(error),
                            deviceSN: this.getSerial(),
                            message: JSON.stringify(message),
    ...
    public processPushNotification(
        ...
        if (
            ...
            try {
                ...
                const error = ensureError(err);
                rootHTTPLogger.debug(
                    `DoorbellLock process push notification - Error`,
                    {
                        error: getError(error),
                        deviceSN: this.getSerial(),
                        eventType: message.event_type,
...
export class SmartDrop extends Camera {
        ...
        if (message.type !== undefined && message.event_type !== undefined) {
            if (message.device_sn === this.getSerial()) {
                try {
                    ...
                    const error = ensureError(err);
                    rootHTTPLogger.debug(
                        `SmartDrop process push notification - Error`,
                        {
                            error: getError(error),
                            deviceSN: this.getSerial(),
                            message: JSON.stringify(message),
    ...
    protected handlePropertyChange(
        ...
        if (metadata.name === PropertyName.DeviceOpen) {
            ...
            metadata.name === PropertyName.DeviceBatteryFullyChargedAlert
        ) {
