...
export enum TfcardStatus {
    TFCARD_BUSY = 6,
    TFCARD_E2FSCK_FAIL_MOUNT_FAIL_REINSERT = 8,
    TFCARD_E2FSCK_FAIL_MOUNT_RO = 9,
    TFCARD_E2FSCK_FAIL_MOUNT_RW = 7,
    TFCARD_E2FSCK_FAIL_MOUNT_RW_ERR = 10,
    TFCARD_FORMATING = 5,
    TFCARD_FORMAT_FAIL = 3,
    TFCARD_MOUNTING = 24,
    TFCARD_MOUNT_FAIL = 2,
    TFCARD_MOUNT_FAIL_E2FSCK_ERROR = 12,
    TFCARD_MOUNT_FAIL_E2FSCK_TIMEOUT = 13,
    TFCARD_MOUNT_RERR_E2FSCK_ERROR = 20,
    TFCARD_MOUNT_RERR_E2FSCK_OK = 19,
    TFCARD_MOUNT_RERR_E2FSCK_TIMEOUT = 21,
    TFCARD_MOUNT_RO_E2FSCK_ERROR = 17,
    TFCARD_MOUNT_RO_E2FSCK_OK = 16,
    TFCARD_MOUNT_RO_E2FSCK_TIMEOUT = 18,
    TFCARD_MOUNT_RW_E2FSCK_ERROR = 14,
    TFCARD_MOUNT_RW_E2FSCK_TIMEOUT = 15,
    TFCARD_NON_ORIGINAL = 1,
    TFCARD_NORMAL = 0,
    TFCARD_NULL = -1,
    TFCARD_REMOVE = 4,
    TFCARD_REPAIRING = 11,
    TFCARD_RISK = 23,
    TFCARD_UNNORMAL_IO_ERROR = 22,
}
