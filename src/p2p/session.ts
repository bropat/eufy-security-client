                            ...
                            if (Device.isLockWifi(this.rawStation.device_type, this.rawStation.station_sn)) {
                                ...
                                if (Device.isLockWifi(this.rawStation.devices[0]?.device_type, this.rawStation.devices[0]?.device_sn) || Device.isLockWifiNoFinger(this.rawStation.devices[0]?.device_type)) {
                                    ...
                                    if (payload.lock_cmd > 0) {
                                        ...
                                        } else if (Device.isLockWifiT8506(this.rawStation.devices[0]?.device_type) || Device.isLockWifiT8502(this.rawStation.devices[0]?.device_type) || Device.isLockWifiT8510P(this.rawStation.devices[0]?.device_type, this.rawStation.devices[0]?.device_sn) || Device.isLockWifiT8520P(this.rawStation.devices[0]?.device_type, this.rawStation.devices[0]?.device_sn) || Device.isLockWifiT8531(this.rawStation.devices[0]?.device_type, this.rawStation.devices[0]?.device_sn)) {
